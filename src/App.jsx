...
const projects = [
    {
        ...
        image: "/OASIS3_Pipeline.jpg",
        imageAlt: "Diagram of the multimodal OASIS-3 neuroimaging pipeline",
    },
    {
        index: "02",
        ...
        image: "/Mouse_Resting_State_Image.jpg",
        imageAlt:
            "Diagram of a mouse resting-state fMRI network dynamics pipeline",
    },
    {
        index: "03",
        ...
        image: "/Parcel_Dbm.jpg",
        imageAlt:
            "Diagram of parcel-level deformation-based morphometry analysis",
    },
    {
        index: "04",
        ...
        imageAlt:
            "Four brain renderings showing stimulation points and activated cortical regions",
    },
    {
        index: "05",
            ...
            <div className="site-card">
                ...
                >
                    <a
                        className="brand"
                        href="#top"
                        aria-label="Luca Galli, back to top"
                        onClick={closeMenu}
                    >
                ...
                <main>
                    <section className="hero" id="top">
                        <div className="hero-layout">
                            <div className="hero-copy">
                                ...
                                <p className="hero-intro reveal reveal-three">
                                    I’m Luca — a Computer Science student and
                                    researcher building AI and machine-learning
                        ...
                        <div
                            className="affiliation-lockup reveal reveal-four"
                            aria-label="Current affiliations"
                        >
                            <a
                                className="affiliation-item university"
                            ...
                            >
                                ...
                                <img
                                    className="unitn-logo"
                                    src="/unitn-logo.svg"
                                    alt="University of Trento"
                                />
                                <small>
                                    B.S. in Computer Science · Expected March
                                    2028
                                </small>
                            </a>
                            <a
                                className="affiliation-item fbk"
                                href="https://www.fbk.eu/"
                                target="_blank"
                                rel="noreferrer"
                            >
                                ...
                                />
                                <small>
                                    Research Assistant · NILab · Since August
                                    2025
                                </small>
                            </a>
                        </div>
                    ...
                    >
                        <div className="organization-heading">
                            <div>
                                <p className="kicker">Research work at</p>
                                <img
                                    className="section-fbk-logo"
                                    src="/fbk-logo.png"
                                    alt="Fondazione Bruno Kessler"
                                />
                            ...
                            <p>
                                ...
                                neuroinformatics, data engineering and
                                ...
                                >
                                    ...
                                    <div className="project-side">
                                        {project.image ? (
                                            ...
                                            <div
                                                className="project-media project-media-empty"
                                                aria-label="Space reserved for a project image"
                                            />
                                        )}
                    ...
                    <section
                        className="university-section section-pad"
                        aria-labelledby="unitn-tutoring-title"
                    >
                        <div className="organization-heading university-heading">
                            <div>
                                <p className="kicker">Teaching at</p>
                                <img
                                    className="section-unitn-logo"
                                    src="/unitn-logo.svg"
                                    alt="University of Trento"
                                />
                                <h2 id="unitn-tutoring-title">
                                    Tutoring experience.
                                </h2>
                            </div>
                            <p>
                                Course tutoring across core programming,
                                machine learning and software-engineering
                                subjects.
                            </p>
                        </div>
                        <ol className="tutoring-list">
                            {tutoringCourses.map((course) => (
                                <li key={course.number}>
                                    <span>{course.number}</span>
                                    <div>
                                        <small>Course tutoring</small>
                    ...
                    >
                        <div className="secondary-heading">
                            ...
                            <p>
                                Smaller collaborative prototypes exploring ideas
                                at speed.
                            </p>
                        </div>
                    ...
                    <section className="about-section section-pad" id="about">
                        <div className="about-copy">
                            ...
                            <p className="about-lead">
                                ...
                                machine learning and deep learning, with an
                                emphasis on reliable methods for
                                high-dimensional scientific and real-world data.
                            </p>
                            <p>
                                At FBK–NILab, I currently work on
                                deformation-based modelling of brain morphology.
                                More broadly, I’m interested in the full
                                machine-learning process—from building robust
                                datasets and selecting meaningful
                                representations to training, evaluating and
                                deploying models.
                            </p>
                        </div>
                            ...
                            <div className="toolkit-card">
                                ...
                                <div className="toolkit-grid">
                                    {tools.map((tool) => (
                                        ...
                                        >
                                            <span
                                                className={`toolkit-icons ${tool.icons.length > 1 ? "is-pair" : ""}`}
                                                aria-hidden="true"
                                            >
                                                {tool.icons.map((icon) => (
                                                    <img
                    ...
                    <section className="principles section-pad">
                        ...
                        <div className="principle-grid">
                            <article>
                                ...
                                <p>
                                    Classical machine learning, deep neural
                                    networks, representation learning and model
                                    evaluation.
                                </p>
                            </article>
                            <article>
                                ...
                                <p>
                                    Deterministic ETL, explicit quality gates,
                                    statistical analysis and reproducible
                                    workflows.
                                </p>
                            </article>
                            <article>
                                ...
                                <p>
                                    ...
                                    scikit-learn, Docker, Git, Linux and web
                                    technologies.
                                </p>
                            </article>
                        </div>
                    ...
                    <section className="contact-section" id="contact">
                        ...
                        <p>
                            ...
                            applied problems and good technical conversations.
                        </p>
                        <a
                ...
                <footer>
                    <a
                        ...
                        href="mailto:lucagalli05@gmail.com"
                    >
                        <Email />
                        <span className="footer-contact-copy">
                            <strong>Contact</strong>
                            <span>lucagalli05@gmail.com</span>
                        </span>
                    </a>
